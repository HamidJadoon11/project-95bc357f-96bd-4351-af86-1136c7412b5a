...
export const translations = {
  ...
  ar: {
    ...
    aboutPrayerTimesDesc: 'يتم حساب مواقيت الصلاة باستخدام طرق فلكية دقيقة. يوفر مواقيت الصلاة أوقات الفجر والشروق والظهر والعصر والمغرب والعشاء لآلاف المدن حول العالم. يتم تحديث الأوقات تلقائياً يومياً باستخدام واجهة برمجة الأذان بطريقة حساب أم القرى.',
