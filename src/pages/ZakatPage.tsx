...
export default function ZakatPage() {
  ...
  useSeo({ title: lang === 'ar' ? 'حاسبة الزكاة الإسلامية - احسب زكاة المال والذهب والفضة | مواقيت' : 'Islamic Zakat Calculator - Calculate Zakat on Cash, Gold & Silver | Prayer Times', description: lang === 'ar' ? 'حاسبة زكاة مجانية ودقيقة تحسب زكاة المال والذهب والفضة والاستثمارات وفقاً للنصاب الشرعي (85 غ ذهب / 595 غ فضة) ونسبة 2.5%.' : 'Free and accurate zakat calculator for cash, gold, silver, and investments based on the shariah nisab (85g gold / 595g silver) and 2.5% rate.', path: '/zakat' });
