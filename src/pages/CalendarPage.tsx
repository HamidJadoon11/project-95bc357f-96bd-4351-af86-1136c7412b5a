...
export default function CalendarPage() {
  ...
  useSeo({ title: lang === 'ar' ? 'التقويم الهجري - التحويل بين التاريخ الهجري والميلادي | مواقيت الصلاة' : 'Hijri Calendar - Convert Between Hijri & Gregorian Dates | Prayer Times', description: lang === 'ar' ? 'تقويم هجري تفاعلي شامل: عرض شهر هجري كامل، التحويل بين التاريخ الهجري والميلادي، ومعرفة المناسبات الإسلامية.' : 'Interactive comprehensive Hijri calendar: view full Hijri months, convert between Hijri and Gregorian dates, and discover Islamic occasions.', path: '/calendar' });
