...
export default function ContactPage() {
  ...
  useEffect(() => {
    document.title = lang === 'ar' ? 'اتصل بنا - راسل فريق مواقيت للدعم والاقتراحات' : 'Contact Us - Reach the Prayer Times Team for Support & Feedback | Prayer Times';
    const desc = lang === 'ar' ? 'تواصل مع فريق مواقيت للإبلاغ عن أخطاء في مواقيت الصلاة، اقتراح مدن جديدة، أو تقديم ملاحظاتك.' : 'Contact the Prayer Times team to report prayer time errors, suggest new cities, or share your feedback.';
