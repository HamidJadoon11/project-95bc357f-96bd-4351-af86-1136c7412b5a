...
export default function AboutPage() {
  ...
  useSeo({ title: lang === 'ar' ? 'عن مواقيت الصلاة - رسالتنا وقيمنا ومنهجنا في حساب مواقيت الصلاة | مواقيت الصلاة' : 'About Prayer Times - Our Mission, Values & Prayer Time Methodology | Prayer Times', description: lang === 'ar' ? 'تعرّف على مواقيت الصلاة: منصة إسلامية عالمية تقدم مواقيت الصلاة الدقيقة، الأذكار، الأدعية، القبلة، والزكاة لأكثر من 80 دولة و600 مدينة. رسالتنا، منهجنا، ومصادرنا الموثوقة.' : 'Learn about Prayer Times: a global Islamic platform providing accurate prayer times, azkar, duas, Qibla, and zakat for 80+ countries and 600+ cities. Our mission, methodology, and trusted sources.', path: '/about' });

  useEffect(() => {
    document.title = lang === 'ar' ? 'عن مواقيت الصلاة - رفيقك الإسلامي اليومي' : 'About Prayer Times - Your Daily Islamic Companion';
  }, [lang]);
      ...
      <section className="islamic-pattern bg-primary px-4 py-16 text-primary-foreground">
        <div className="container mx-auto text-center">
          <h1 className="font-heading text-4xl font-bold text-gold md:text-5xl">
            {lang === 'ar' ? 'عن مواقيت الصلاة' : 'About Prayer Times'}
          </h1>
          <p className="mx-auto mt-4 max-w-2xl text-sm leading-relaxed opacity-80">
            {lang === 'ar'
              ? 'مواقيت الصلاة هو رفيقك الإسلامي اليومي، مصمم ليكون المصدر الأول والأكثر دقة لمواقيت الصلاة والأذان حول العالم. نسعى لتقديم تجربة سلسة وشاملة تلبي احتياجات المسلمين اليومية.'
