...
export default function DisclaimerPage() {
  ...
  useSeo({
    title: lang === 'ar'
      ? 'إخلاء المسؤولية - مواقيت الصلاة والمحتوى الإسلامي | مواقيت الصلاة'
      : 'Disclaimer - Prayer Times & Islamic Content Accuracy | Prayer Times',
    description: lang === 'ar'
      ? 'إخلاء المسؤولية الرسمي لموقع مواقيت الصلاة حول دقة مواقيت الصلاة، وحسابات الزكاة، واتجاه القبلة، والمحتوى الإسلامي. اعرف حدود مسؤوليتنا وكيفية استخدام المعلومات.'
      ...
      <div className="container mx-auto max-w-3xl px-4 py-12">
        ...
        <div className="mt-8 space-y-6 text-sm leading-relaxed text-foreground">
          <section>
            ...
            <p className="mt-2">المعلومات المقدمة على موقع مواقيت الصلاة (المشار إليه لاحقاً بـ"الموقع") هي لأغراض معلوماتية ودعوية عامة فقط. على الرغم من حرصنا على تقديم معلومات دقيقة ومحدثة، فإننا لا نقدم أي ضمانات صريحة أو ضمنية حول اكتمال أو دقة أو موثوقية أو ملاءمة المعلومات لغرض معين.</p>
          </section>

          <section>
            <h2 className="font-heading text-xl font-bold">دقة مواقيت الصلاة</h2>
            <p className="mt-2">تُحسب مواقيت الصلاة المعروضة على الموقع باستخدام واجهة برمجة تطبيقات Aladhan الفلكية ووفقاً لطرق حسابية معتمدة مثل أم القرى، رابطة العالم الإسلامي، ISNA، ومصر. قد تختلف هذه المواقيت الصلاة اختلافاً طفيفاً عن مواقيت الصلاة المسجد المحلي بسبب اختلاف طرق الحساب، والارتفاع، والظروف الجغرافية الدقيقة. نوصي دائماً بمراجعة المسجد المحلي أو الجهة الدينية الرسمية في بلدك لتأكيد المواقيت الصلاة للعبادة.</p>
          </section>
