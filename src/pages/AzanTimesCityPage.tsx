...
export default function AzanTimesCityPage() {
  ...
  useEffect(() => {
    ...
    document.title = lang === 'ar' ? `أوقات الأذان في ${city.nameAr} اليوم - أذان الفجر، الظهر، العصر، المغرب، العشاء | ${country.nameAr} - مواقيت الصلاة` : `Azan Times in ${city.nameEn} Today - Fajr, Dhuhr, Asr, Maghrib, Isha Azan | ${country.nameEn} - Prayer Times`;
